...
function initializeSubjects() {
    ...
    const openSubmitTaskModal = function(subjectIndex, taskIndex) {
        ...
        document.getElementById('submitTaskSubjectIndex').value = subjectIndex;
        document.getElementById('submitTaskIndex').value = taskIndex;
